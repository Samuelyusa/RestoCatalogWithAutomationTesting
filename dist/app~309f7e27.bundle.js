"use strict";
(self["webpackChunkrestocatalog_pwa"] = self["webpackChunkrestocatalog_pwa"] || []).push([[924],{
  ...
  _createClass(FavoriteRestoSearchPresenter, [{
    ...
    value: function () {
      var _searchRestaurant2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(latestQuery) {
        var _this$latestQuery;
        var foundRestaurants;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              this._latestQuery = latestQuery.trim();
              if (!(((_this$latestQuery = this.latestQuery) === null || _this$latestQuery === void 0 ? void 0 : _this$latestQuery.length) > 0)) {
                _context.next = 7;
                break;
              }
              _context.next = 4;
              return this._favoriteRestaurants.searchRestaurant(this._latestQuery);
            case 4:
    ...
    value: function _showFoundRestaurant(restaurants) {
    ...
    key: "_deleteSkeleton",
    value: function _deleteSkeleton() {
      var allSkeleton = document.querySelectorAll('.skeleton');
      var allSkeletonText = document.querySelectorAll('.skeleton-text');
      var allSkeletonTitle = document.querySelectorAll('.skeleton-title');
      allSkeletonText.forEach(function (item) {
        item.classList.remove('skeleton-text');
      });
      allSkeletonTitle.forEach(function (item) {
    ...
    value: function showFavoriteRestaurants() {
      ...
      if (restaurants.length) {
        html = restaurants.reduce(function (carry, restaurant) {
          return carry.concat((0,_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createrestaurantItemTemplate */ .jo)(restaurant));
        }, '');
      } else {
...
/* harmony export */   jo: () => (/* binding */ createrestaurantItemTemplate),
/* harmony export */   k8: () => (/* binding */ displayNewReviewTemplate),
/* harmony export */   p_: () => (/* binding */ createrestaurantDetailTemplate),
...
/* harmony import */ var lazysizes_plugins_parent_fit_ls_parent_fit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(770);
...
var displayNewReviewTemplate = function displayNewReviewTemplate() {
  return "\n    <div id=\"restaurant__Newcomment\"></div>";
};
var createrestaurantItemTemplate = function createrestaurantItemTemplate(restaurant) {
  return "\n    <div class=\"restaurant-item\">\n        <div class=\"restaurant-item__header\">\n        <picture>\n            <source media=\"(max-width: 1024px)\" data-srcset=\"".concat(restaurant.pictureId ? _globals_config__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.BASE_IMAGE_URL_SMALL + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale', "\">\n            <img data-src=\"").concat(restaurant.pictureId ? _globals_config__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.BASE_IMAGE_URL_MEDIUM + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale', "\"\n                alt=\"").concat(restaurant.name || '-', "\"\n                class=\"restaurant-item__header__poster lazyload skeleton\">\n        </picture>\n        \n        <div class=\"restaurant-item__header__rating\">\n            <span><img src=\"").concat(_globals_config__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.ICON, "/star-rate.png\" alt=\"\" class=\"star-rate skeleton\"></span><span class=\"restaurant-item__header__rating__score\">").concat(restaurant.rating || '-', "</span>\n        </div>\n        </div>\n        <div class=\"restaurant-item__content\">\n        <h3 class=\"restaurant__title skeleton\"><a href=\"/#/detail/").concat(restaurant.id, "\">").concat(restaurant.name || '-', "</a></h3>\n        <p class=\"skeleton\">").concat(restaurant.description || '-', "</p>\n        </div>\n    </div>");
};
